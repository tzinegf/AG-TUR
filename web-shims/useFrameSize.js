...
import { useSafeAreaFrame, SafeAreaListener } from 'react-native-safe-area-context';
...
function FrameSizeProviderInner({ initialFrame, children }) {
  ...
  return /*#__PURE__*/_jsxs(_Fragment, {
    children: [
      Platform.OS === 'web'
        ? /*#__PURE__*/_jsx(FrameSizeListenerWeb, { onChange: onChange })
        : typeof SafeAreaListener === 'undefined'
        ? /*#__PURE__*/_jsx(FrameSizeListenerNativeFallback, { onChange: onChange })
        : /*#__PURE__*/_jsx(SafeAreaListener, { onChange: ({ frame }) => onChange(frame), style: StyleSheet.absoluteFill }),
      /*#__PURE__*/_jsx(FrameContext.Provider, { value: context, children: children }),
    ],
  });
}
